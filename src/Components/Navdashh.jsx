    ...
    <header className="flex h-[85px] w-full items-center justify-end border-2 border-l-0 bg-white px-8">
      <div className="flex items-center gap-3">
        ...
        <div className="text-right">
          ...
          <p className="text-[12px] text-[#637381]">Admin</p>
        </div>
        <img src={usermin} alt="" className="h-10 w-10 rounded-full" />
      </div>
    </header>
  )
}
