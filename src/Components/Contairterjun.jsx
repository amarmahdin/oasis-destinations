  ...
  return (
    <div>
      ...
      <div className='h-[1600px] bg-[#EDF5F9]'>
        <h1 className='text-[48px] font-semibold mx-[130px] py-4'>Air Terjun</h1>
        <p className='text-[24px] text-gray-400 mx-[130px]'>Menampilkan hasil destinasi air terjun</p>
        <div className='py-10'>
