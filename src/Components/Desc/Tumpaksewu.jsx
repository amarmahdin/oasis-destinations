...
function Tumpaksewu() {
  return (
    <>
    <div>
      <img src={tumpaksewu} alt="" className="w-[100%]" />
      <div className="ml-10 mt-3">
        ...
        <div id="r" className="mt-5 flex">
          <div className="w-[800px] ml-20 mt-3">
            <h1 className="text-[36px] font-semibold">Air Terjun Tumpak Sewu</h1>
            <img src={locg} alt="" />
            <p className="-translate-y-7 translate-x-8">
            Air Terjun Tumpak Sewu, Besucukit, Sidomulyo, Kec. Pronojiwo, Kabupaten Lumajang, Jawa Timur
            Indonesia
            </p>
          </div>
      ...
      <div id="l" className="w-[1304px] h-[374px] border-4 rounded-2xl ml-40 mt-20 mb-10">
        <div className="w-[100%] h-[216px]">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3948.726701312684!2d112.91496757456113!3d-8.230214232623535!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd61581c8983803%3A0xf80a831c92d392cb!2sAir%20Terjun%20Tumpak%20Sewu!5e0!3m2!1sid!2sid!4v1718165714373!5m2!1sid!2sid"
            width="100%"
            height="216"
            allowFullScreen
            loading="lazy"
          ...
          <a href="https://maps.app.goo.gl/2hEVWtrAsoRxW43X7"><button className="border-2 rounded-md text-white bg-[#0047FF] py-2 px-2 ml-[1150px] -translate-y-10">Lihat Peta</button></a>
        </div>
      </div>
    </div>
    </>
